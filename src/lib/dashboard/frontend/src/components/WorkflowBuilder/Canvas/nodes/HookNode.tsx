/**
 * HookNode Component
 * Custom node type for workflow hooks with validation error support
 */
...
export function HookNode({ data, selected }: HookNodeProps): JSX.Element {
  ...
  const borderClass = hasErrors
    ...
    : selected
    ? "border-cyan-400 border-2 shadow-[0_0_0_3px_rgba(34,211,238,0.3)]"
  ...
  return (
    <div className={`px-4 py-3 ${bgClass} ${borderClass} rounded shadow-lg min-w-[150px] relative`}>
      ...
      <div className="flex items-center gap-2 mb-2">
        ...
        <div className="text-gray-100 text-sm font-medium">Hook</div>
      </div>
      ...
      <Handle
        ...
        className="!bg-cyan-400 !w-3 !h-3 !border-2 !border-gray-800"
      />
