...
<p align="center">
  <img src="https://vhs.charm.sh/vhs-3lXEPhTzuzkZbq6p6wH7dV.gif" alt="Demo" />
</p>
...
1. **Prompt for workflow preferences:**
   - Git sync before each task? (default: yes)
   - Use pull requests instead of direct merges? (default: yes)
